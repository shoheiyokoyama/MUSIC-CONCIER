...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-utakata/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'NVActivityIndicatorView.framework'
  install_framework 'RMPZoomTransitionAnimator.framework'
